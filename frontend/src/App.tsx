...
function App() {
    ...
    const handleConfirmSave = (restart: boolean) => {
        ...
        saveConfig(
            { ...localConfig, _restartGateway: restart },
            {
                onSuccess: () => {
            ...
            {showRestartConfirm && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    <div
                        ...
                        aria-hidden="true"
                        onClick={() =>
                            !isSaving && setShowRestartConfirm(false)
                        }
                    />
                    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-md w-full mx-4 relative flex flex-col z-10 p-6">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                            Do you want to restart the gateway after saving?
                            This ensures your new configuration takes effect
                            immediately.
                        </p>
